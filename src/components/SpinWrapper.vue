        ...
        <div class="w-full max-w-md bg-gradient-to-br from-purple-900 to-indigo-900 rounded-2xl p-6 shadow-2xl">
          ...
          <form @submit.prevent="redeemCode">
            <input
              ...
              class="w-full px-4 py-3 rounded-xl bg-purple-800/50 border-2 border-purple-500/50 text-white text-center text-xl font-bold uppercase tracking-widest placeholder-purple-400 focus:border-yellow-400 focus:outline-none"
